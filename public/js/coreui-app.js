 ...
 */
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"vue-resource\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
    ...
    next(function (response) {
        switch (response.status) {
            ...
            case 400:
                break;
            default:
                Admin.Messages.error(trans('lang.message.something_went_wrong'), response.data.message || '');
        }
    });
});
